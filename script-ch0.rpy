label ch0_main:
    ...
    s "Я думала, что поймаю тебя, когда ты будешь выходить из класса, но увидела, как ты сидишь тут и просто витаешь в облаках, поэтому зашла."
    ...
    s "Нуу, я посчитала, что тебе нужен некий стимул, поэтому я подумала, ну, знаешь..."
    mc "Знаю что?"
    s "Нуу, что ты мог бы вступить в мой клуб!"
    mc "Сайори..."
    s "Дааа??"
    ...
    y "Но знаешь, мне нравятся и многие другие вещи."
    y "Истории с глубокой психологией частенько заставляют меня нырнуть в них с головой."
    y "Разве не удивительно то, как писатель может воспользоваться нашим собственным отсутствием воображения, чтобы выбить нас из колеи?"
