...
label splashscreen:
    ...
    python:
        ...
        if renpy.android :
            import os
            try:
                firstrun = renpy.file(os.environ['ANDROID_PUBLIC'] + "/firstrun")
            except:
                with open(os.environ['ANDROID_PUBLIC'] + "/firstrun", "wb") as f:
...
label readonly:
    scene black
    "Fuck, please contact Otorhin!"
    "https://github.com/otorhin"
    $ renpy.quit()
    return
